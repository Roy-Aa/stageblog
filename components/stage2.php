<div id="stageplek" class="w-full h-auto rounded-md border border-gray-700 p-6 flex flex-col gap-5">
    ...
    <div class="observe grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="observe delay-100 rounded-md border border-gray-700 p-6 flex flex-col gap-2">
            <div class="flex gap-2 items-center">
                <h2>Dunico <span class="text-[#20C0FD]">-</span> Web Design & Online Marketing </h2>
                <div class="flex cursor-default select-none" onclick="this.style.animation = 'disappear 1.5s ease-in forwards'"><span class="text-[#20C0FD] text-2xl font-black">d</span><span class="text-[#585858] text-2xl font-black">.</span></div>
            </div>
    ...
    <div class="observe w-full h-auto flex flex-col p-6 border border-gray-700 rounded-md gap-4">
        ...
        <div class="w-full h-auto p-6 border border-gray-700 rounded-md items-center text-center">
            <p>???</p>
        </div>
    </div>
</div>