    ...
    <section class="w-[1200px] h-auto px-5">
        ...
        <div class="flex flex-col items-center justify-center gap-7 w-full h-[100vh] select-none">
            ...
            <div class="observe delay-100 animate-fadein flex gap-4 items-center">
                <svg id="rotatingIcon" class="duration-1000" xmlns="http://www.w3.org/2000/svg" fill="#00BCFF" width="27" height="27" viewBox="0 0 24 24">
        ...
        <div id="stageplek" class="my-10 w-full h-auto rounded-md border border-gray-700 p-6 flex flex-col gap-5">
            ...
            <div class="observe w-full h-auto flex flex-col p-6 border border-gray-700 rounded-md">
                ...
                <div class="h-[5px] w-full bg-white rounded-full relative">
                    <div class="absolute h-[5px] w-88/100 bg-tailwindblue rounded-full"></div>
                </div>
            </div>
            ...
            <div class="w-full h-auto flex flex-col p-6 border border-gray-700 rounded-md gap-4">
                ...
                <div class="observe w-full h-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 p-6 border border-gray-700 rounded-md items-center">
                    ...
                    <a class="observe group delay-125 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://tailwindcss.com/"><img class="h-20 w-25 group-hover:scale-105 duration-100 object-contain" src="<?php echo get_template_directory_uri(); ?>/assets/img/Tailwind.svg" alt="Logo"></a>
                    <a class="observe group delay-150 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://laravel.com/"><img class="h-20 group-hover:scale-105 duration-100 object-contain" src="<?php echo get_template_directory_uri(); ?>/assets/img/Laravel.png" alt="Logo"></a>
                    <a class="observe group delay-175 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://www.gravityforms.com/"><img class="h-20 group-hover:scale-105 duration-100 object-contain" src="<?php echo get_template_directory_uri(); ?>/assets/img/Gravityforms.png" alt="Logo"></a>
                    <a class="observe group delay-200 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://www.advancedcustomfields.com/"><img class="h-20 group-hover:scale-105 duration-100 object-contain" src="<?php echo get_template_directory_uri(); ?>/assets/img/acficon.svg" alt="Logo"></a>
                    <a class="observe group delay-225 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://wpmailsmtp.com/"><img class="h-20 group-hover:scale-105 duration-100 object-contain" src="<?php echo get_template_directory_uri(); ?>/assets/img/wpmailsmtp.png" alt="Logo"></a>
                    <a class="observe group delay-250 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://duplicator.com/"><img class="h-20 group-hover:scale-105 duration-100 object-contain" src="<?php echo get_template_directory_uri(); ?>/assets/img/Duplicator.webp" alt="Logo"></a>
                    <a class="observe group delay-275 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://facetwp.com/"><img class="h-20 w-25 object-contain group-hover:scale-105 duration-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/facetwp-logo-circle.png" alt="Logo"></a>
                    <a class="observe group delay-300 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://www.figma.com/"><img class="h-20 group-hover:scale-105 duration-100 object-contain" src="<?php echo get_template_directory_uri(); ?>/assets/img/Figma.png" alt="Logo"></a>
                    <a class="observe group delay-325 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://mailtrap.io/"><img class="h-20 group-hover:scale-105 duration-100 object-contain" src="<?php echo get_template_directory_uri(); ?>/assets/img/Mailtrap.png" alt="Logo"></a>
                    <a class="observe group delay-350 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://www.megamenu.com/"><img class="h-20 group-hover:scale-105 duration-100 object-contain" src="<?php echo get_template_directory_uri(); ?>/assets/img/MMM.png" alt="Logo"></a>
                    <a class="observe group delay-375 rounded-md border border-gray-700 p-6 flex items-center justify-center" target="_blank" href="https://woocommerce.com/"><img class="h-20 group-hover:scale-105 duration-100 object-contain" src="<?php echo get_template_directory_uri(); ?>/assets/img/woocommerce-logo_brandlogos.net_9i40c.png" alt="Logo"></a>
                </div>
            </div>
        </div>
